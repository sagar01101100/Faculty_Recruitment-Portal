...
CREATE ROLE dhushyanth;
ALTER ROLE dhushyanth WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN NOREPLICATION NOBYPASSRLS;
...
--
-- Name: Admin; Type: TABLE; Schema: public; Owner: dhushyanth
--
...
ALTER TABLE public."Admin" OWNER TO dhushyanth;

--
-- Name: Department; Type: TABLE; Schema: public; Owner: dhushyanth
--
...
ALTER TABLE public."Department" OWNER TO dhushyanth;

--
-- Name: Entry; Type: TABLE; Schema: public; Owner: dhushyanth
--
...
ALTER TABLE public."Entry" OWNER TO dhushyanth;

--
-- Name: Entry_id_seq; Type: SEQUENCE; Schema: public; Owner: dhushyanth
--
...
ALTER TABLE public."Entry_id_seq" OWNER TO dhushyanth;

--
-- Name: Entry_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: dhushyanth
--
...
--
-- Name: Field; Type: TABLE; Schema: public; Owner: dhushyanth
--
...
CREATE TABLE public."Field" (
    ...
    "allowFile" boolean DEFAULT false NOT NULL,
...
ALTER TABLE public."Field" OWNER TO dhushyanth;

--
-- Name: FieldGroup; Type: TABLE; Schema: public; Owner: dhushyanth
--
...
ALTER TABLE public."FieldGroup" OWNER TO dhushyanth;

--
-- Name: FieldGroup_id_seq; Type: SEQUENCE; Schema: public; Owner: dhushyanth
--

CREATE SEQUENCE public."FieldGroup_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."FieldGroup_id_seq" OWNER TO dhushyanth;

--
-- Name: FieldGroup_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: dhushyanth
--

ALTER SEQUENCE public."FieldGroup_id_seq" OWNED BY public."FieldGroup".id;


--
-- Name: Field_id_seq; Type: SEQUENCE; Schema: public; Owner: dhushyanth
--
...
ALTER TABLE public."Field_id_seq" OWNER TO dhushyanth;

--
-- Name: Field_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: dhushyanth
--
...
--
-- Name: PasswordResetRequest; Type: TABLE; Schema: public; Owner: dhushyanth
--
...
ALTER TABLE public."PasswordResetRequest" OWNER TO dhushyanth;

--
-- Name: Position; Type: TABLE; Schema: public; Owner: dhushyanth
--
...
ALTER TABLE public."Position" OWNER TO dhushyanth;

--
-- Name: Referral; Type: TABLE; Schema: public; Owner: dhushyanth
--
...
ALTER TABLE public."Referral" OWNER TO dhushyanth;

--
-- Name: ReferralEntry; Type: TABLE; Schema: public; Owner: dhushyanth
--

CREATE TABLE public."ReferralEntry" (
    id integer NOT NULL,
    content text NOT NULL,
    "updatedAt" timestamp(3) without time zone NOT NULL,
...
ALTER TABLE public."ReferralEntry" OWNER TO dhushyanth;

--
-- Name: ReferralEntry_id_seq; Type: SEQUENCE; Schema: public; Owner: dhushyanth
--

CREATE SEQUENCE public."ReferralEntry_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."ReferralEntry_id_seq" OWNER TO dhushyanth;

--
-- Name: ReferralEntry_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: dhushyanth
--

ALTER SEQUENCE public."ReferralEntry_id_seq" OWNED BY public."ReferralEntry".id;


--
-- Name: ReferralField; Type: TABLE; Schema: public; Owner: dhushyanth
--

CREATE TABLE public."ReferralField" (
    id integer NOT NULL,
    title text NOT NULL,
    description text,
    type text NOT NULL,
...
ALTER TABLE public."ReferralField" OWNER TO dhushyanth;

--
-- Name: ReferralField_id_seq; Type: SEQUENCE; Schema: public; Owner: dhushyanth
--

CREATE SEQUENCE public."ReferralField_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."ReferralField_id_seq" OWNER TO dhushyanth;

--
-- Name: ReferralField_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: dhushyanth
--

ALTER SEQUENCE public."ReferralField_id_seq" OWNED BY public."ReferralField".id;


--
-- Name: Snapshot; Type: TABLE; Schema: public; Owner: dhushyanth
--
...
ALTER TABLE public."Snapshot" OWNER TO dhushyanth;

--
-- Name: TemplateEntries; Type: TABLE; Schema: public; Owner: dhushyanth
--

CREATE TABLE public."TemplateEntries" (
    id integer NOT NULL,
    content text NOT NULL,
    "updatedAt" timestamp(3) without time zone NOT NULL,
    "fieldId" integer,
...
ALTER TABLE public."TemplateEntries" OWNER TO dhushyanth;

--
-- Name: TemplateEntries_id_seq; Type: SEQUENCE; Schema: public; Owner: dhushyanth
--

CREATE SEQUENCE public."TemplateEntries_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."TemplateEntries_id_seq" OWNER TO dhushyanth;

--
-- Name: TemplateEntries_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: dhushyanth
--

ALTER SEQUENCE public."TemplateEntries_id_seq" OWNED BY public."TemplateEntries".id;


--
-- Name: UploadHistory; Type: TABLE; Schema: public; Owner: dhushyanth
--
...
CREATE TABLE public."UploadHistory" (
    ...
    "userId" text NOT NULL,
    "fieldId" integer NOT NULL,
    "uploadAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);


ALTER TABLE public."UploadHistory" OWNER TO dhushyanth;

--
-- Name: UploadHistory_id_seq; Type: SEQUENCE; Schema: public; Owner: dhushyanth
--

CREATE SEQUENCE public."UploadHistory_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public."UploadHistory_id_seq" OWNER TO dhushyanth;

--
-- Name: UploadHistory_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: dhushyanth
--

ALTER SEQUENCE public."UploadHistory_id_seq" OWNED BY public."UploadHistory".id;


--
-- Name: User; Type: TABLE; Schema: public; Owner: dhushyanth
--
...
ALTER TABLE public."User" OWNER TO dhushyanth;

--
-- Name: VerificationRequest; Type: TABLE; Schema: public; Owner: dhushyanth
--
...
ALTER TABLE public."VerificationRequest" OWNER TO dhushyanth;

--
-- Name: _prisma_migrations; Type: TABLE; Schema: public; Owner: dhushyanth
--
...
ALTER TABLE public._prisma_migrations OWNER TO dhushyanth;

--
-- Name: Entry id; Type: DEFAULT; Schema: public; Owner: dhushyanth
--
...
--
-- Name: Field id; Type: DEFAULT; Schema: public; Owner: dhushyanth
--
...
--
-- Name: FieldGroup id; Type: DEFAULT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."FieldGroup" ALTER COLUMN id SET DEFAULT nextval('public."FieldGroup_id_seq"'::regclass);


--
-- Name: ReferralEntry id; Type: DEFAULT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."ReferralEntry" ALTER COLUMN id SET DEFAULT nextval('public."ReferralEntry_id_seq"'::regclass);


--
-- Name: ReferralField id; Type: DEFAULT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."ReferralField" ALTER COLUMN id SET DEFAULT nextval('public."ReferralField_id_seq"'::regclass);


--
-- Name: TemplateEntries id; Type: DEFAULT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."TemplateEntries" ALTER COLUMN id SET DEFAULT nextval('public."TemplateEntries_id_seq"'::regclass);


--
-- Name: UploadHistory id; Type: DEFAULT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."UploadHistory" ALTER COLUMN id SET DEFAULT nextval('public."UploadHistory_id_seq"'::regclass);
...
--
-- Name: Admin Admin_pkey; Type: CONSTRAINT; Schema: public; Owner: dhushyanth
--
...
--
-- Name: Department Department_pkey; Type: CONSTRAINT; Schema: public; Owner: dhushyanth
--
...
--
-- Name: Entry Entry_pkey; Type: CONSTRAINT; Schema: public; Owner: dhushyanth
--
...
--
-- Name: FieldGroup FieldGroup_pkey; Type: CONSTRAINT; Schema: public; Owner: dhushyanth
--
...
--
-- Name: Field Field_pkey; Type: CONSTRAINT; Schema: public; Owner: dhushyanth
--
...
--
-- Name: PasswordResetRequest PasswordResetRequest_pkey; Type: CONSTRAINT; Schema: public; Owner: dhushyanth
--
...
--
-- Name: Position Position_pkey; Type: CONSTRAINT; Schema: public; Owner: dhushyanth
--
...
--
-- Name: ReferralEntry ReferralEntry_pkey; Type: CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."ReferralEntry"
    ADD CONSTRAINT "ReferralEntry_pkey" PRIMARY KEY (id);


--
-- Name: ReferralField ReferralField_pkey; Type: CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."ReferralField"
    ADD CONSTRAINT "ReferralField_pkey" PRIMARY KEY (id);


--
-- Name: Referral Referral_pkey; Type: CONSTRAINT; Schema: public; Owner: dhushyanth
--
...
--
-- Name: Snapshot Snapshot_pkey; Type: CONSTRAINT; Schema: public; Owner: dhushyanth
--
...
--
-- Name: TemplateEntries TemplateEntries_pkey; Type: CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."TemplateEntries"
    ADD CONSTRAINT "TemplateEntries_pkey" PRIMARY KEY (id);


--
-- Name: UploadHistory UploadHistory_pkey; Type: CONSTRAINT; Schema: public; Owner: dhushyanth
--
...
--
-- Name: User User_pkey; Type: CONSTRAINT; Schema: public; Owner: dhushyanth
--
...
--
-- Name: VerificationRequest VerificationRequest_pkey; Type: CONSTRAINT; Schema: public; Owner: dhushyanth
--
...
--
-- Name: _prisma_migrations _prisma_migrations_pkey; Type: CONSTRAINT; Schema: public; Owner: dhushyanth
--
...
--
-- Name: Admin_email_idx; Type: INDEX; Schema: public; Owner: dhushyanth
--
...
--
-- Name: Admin_email_key; Type: INDEX; Schema: public; Owner: dhushyanth
--
...
--
-- Name: Referral_email_key; Type: INDEX; Schema: public; Owner: dhushyanth
--

CREATE UNIQUE INDEX "Referral_email_key" ON public."Referral" USING btree (email);


--
-- Name: Snapshot_userId_departmentId_positionId_key; Type: INDEX; Schema: public; Owner: dhushyanth
--

CREATE UNIQUE INDEX "Snapshot_userId_departmentId_positionId_key" ON public."Snapshot" USING btree ("userId", "departmentId", "positionId");


--
-- Name: User_email_key; Type: INDEX; Schema: public; Owner: dhushyanth
--
...
--
-- Name: Entry Entry_entryId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."Entry"
    ADD CONSTRAINT "Entry_entryId_fkey" FOREIGN KEY ("entryId") REFERENCES public."Entry"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: Entry Entry_fieldId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."Entry"
    ADD CONSTRAINT "Entry_fieldId_fkey" FOREIGN KEY ("fieldId") REFERENCES public."Field"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: Entry Entry_snapshotId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."Entry"
    ADD CONSTRAINT "Entry_snapshotId_fkey" FOREIGN KEY ("snapshotId") REFERENCES public."Snapshot"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: Field Field_fieldGroupId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."Field"
    ADD CONSTRAINT "Field_fieldGroupId_fkey" FOREIGN KEY ("fieldGroupId") REFERENCES public."FieldGroup"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: Field Field_fieldId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."Field"
    ADD CONSTRAINT "Field_fieldId_fkey" FOREIGN KEY ("fieldId") REFERENCES public."Field"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: PasswordResetRequest PasswordResetRequest_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."PasswordResetRequest"
    ADD CONSTRAINT "PasswordResetRequest_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: ReferralEntry ReferralEntry_fieldId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."ReferralEntry"
    ADD CONSTRAINT "ReferralEntry_fieldId_fkey" FOREIGN KEY ("fieldId") REFERENCES public."ReferralField"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: ReferralEntry ReferralEntry_referralId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."ReferralEntry"
    ADD CONSTRAINT "ReferralEntry_referralId_fkey" FOREIGN KEY ("referralId") REFERENCES public."Referral"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: Referral Referral_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."Referral"
    ADD CONSTRAINT "Referral_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: Snapshot Snapshot_departmentId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."Snapshot"
    ADD CONSTRAINT "Snapshot_departmentId_fkey" FOREIGN KEY ("departmentId") REFERENCES public."Department"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: Snapshot Snapshot_positionId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."Snapshot"
    ADD CONSTRAINT "Snapshot_positionId_fkey" FOREIGN KEY ("positionId") REFERENCES public."Position"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: Snapshot Snapshot_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."Snapshot"
    ADD CONSTRAINT "Snapshot_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: TemplateEntries TemplateEntries_fieldId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."TemplateEntries"
    ADD CONSTRAINT "TemplateEntries_fieldId_fkey" FOREIGN KEY ("fieldId") REFERENCES public."Field"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: UploadHistory UploadHistory_fieldId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."UploadHistory"
    ADD CONSTRAINT "UploadHistory_fieldId_fkey" FOREIGN KEY ("fieldId") REFERENCES public."Field"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: UploadHistory UploadHistory_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."UploadHistory"
    ADD CONSTRAINT "UploadHistory_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: VerificationRequest VerificationRequest_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: dhushyanth
--

ALTER TABLE ONLY public."VerificationRequest"
    ADD CONSTRAINT "VerificationRequest_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
